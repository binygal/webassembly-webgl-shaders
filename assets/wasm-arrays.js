...
const ccallArrays = (
      ...
      if (t)
        for (let r = 0; r < t.length; r++)
          if ("array" == a[r] || Array.isArray(t[r])) {
            ...
            for (let a = 0; a < t[r].length; a++) e[a] = t[r][a];
            ...
            o.push(a),
              ...
              h.push("number"),
              h.push("number");
          } else y.push(t[r]), h.push(void 0 == a[r] ? "number" : a[r]);
      u = Module.ccall(r, E, h, y);
    } catch (r) {
      c = r;
    } finally {
      for (let r = 0; r < o.length; r++) Module._free(o[r]);
    }
    if (c) throw c;
    if ("array" == e) {
      const r = [];
  ...
  cwrapArrays = (
    ...
    ccallArrays(r, e, a, n, { heapIn: t, heapOut: A, returnArraySize: s });
