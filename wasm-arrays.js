...
export const ccallArrays = (
  ...
  paramTypes,
  params,
  { heapIn = "HEAPF32", heapOut = "HEAPF32", returnArraySize = 1 } = {}
) => {
  const heapMap = {};
  ...
  if (returnType == "array") {
    ...
    for (let v = 0; v < returnArraySize; v++) {
      returnData.push(
        Module[heapOut][res / heapMap[heapOut].BYTES_PER_ELEMENT + v]
      );
    }
...
const cwrapArrays = (
  ...
  return params =>
    ccallArrays(func, returnType, paramTypes, params, {
      heapIn,
      heapOut,
      returnArraySize
    });
...
typeof window == "undefined" &&
  (exports.ccallArrays = ccallArrays) & (exports.cwrapArrays = cwrapArrays);
